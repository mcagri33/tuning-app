                    ...
                    <div class="">
                        <div class="d-flex align-items-start gap-3">
                            <div class="product-box border">
                                <img src="{{asset('assets/admin/images/products/05.png')}}" alt="product img">
                            </div>
                        ...
                        <div class="d-flex align-items-start gap-3">
                            <div class="product-box border">
                                <img src="{{asset('assets/admin/images/products/07.png')}}" alt="product img">
                            </div>
                            <div class="flex-grow-1">
                                <div class="progress-wrapper">
                                    <p class="my-2">iPhone 11 - A24512 <span class="float-end">(4,216 Orders) <span class="ms-3 fw-bold">42%</span></span></p>
                        ...
                        <div class="d-flex align-items-start gap-3">
                            <div class="product-box border">
                                <img src="{{asset('assets/admin/images/products/09.png')}}" alt="product img">
                            </div>
                            <div class="flex-grow-1">
                                <div class="progress-wrapper">
                                    <p class="my-2">iPhone 11 - A24512 <span class="float-end">(4,216 Orders) <span class="ms-3 fw-bold">42%</span></span></p>
                        ...
                        <div class="d-flex align-items-start gap-3">
                            <div class="product-box border">
                                <img src="{{asset('assets/admin/images/products/02.png')}}" alt="product img">
                            </div>
                            <div class="flex-grow-1">
                                <div class="progress-wrapper">
                                    <p class="my-2">iPhone 11 - A24512 <span class="float-end">(4,216 Orders) <span class="ms-3 fw-bold">42%</span></span></p>
                        ...
                        <div class="d-flex align-items-start gap-3">
                            <div class="product-box border">
                                <img src="{{asset('assets/admin/images/products/04.png')}}" alt="product img">
                            </div>
                            <div class="flex-grow-1">
                                <div class="progress-wrapper">
                                    <p class="my-2">iPhone 11 - A24512 <span class="float-end">(4,216 Orders) <span class="ms-3 fw-bold">42%</span></span></p>
                    ...
                    <div class="review-list">
                        <div class="d-flex align-items-start">
                            <div class="review-user">
                                <img src="{{asset('assets/admin/images/avatars/avatar-1.png')}}" width="65" height="65" class="rounded-circle" alt="">
                            </div>
                        ...
                        <div class="d-flex align-items-start">
                            <div class="review-user">
                                <img src="{{asset('assets/admin/images/avatars/avatar-2.png')}}" width="65" height="65" class="rounded-circle" alt="">
                            </div>
                            <div class="review-content ms-3">
                                <div class="rates cursor-pointer fs-6">
                                    <i class="bx bxs-star text-warning"></i>
                        ...
                        <div class="d-flex align-items-start">
                            <div class="review-user">
                                <img src="{{asset('assets/admin/images/avatars/avatar-3.png')}}" width="65" height="65" class="rounded-circle" alt="">
                            </div>
                            <div class="review-content ms-3">
                                <div class="rates cursor-pointer fs-6">
                                    <i class="bx bxs-star text-warning"></i>
                        ...
                        <div class="d-flex align-items-start">
                            <div class="review-user">
                                <img src="{{asset('assets/admin/images/avatars/avatar-4.png')}}" width="65" height="65" class="rounded-circle" alt="">
                            </div>
                            <div class="review-content ms-3">
                                <div class="rates cursor-pointer fs-6">
                                    <i class="bx bxs-star text-warning"></i>
                        ...
                        <div class="d-flex align-items-start">
                            <div class="review-user">
                                <img src="{{asset('assets/admin/images/avatars/avatar-5.png')}}" width="65" height="65" class="rounded-circle" alt="">
                            </div>
                            <div class="review-content ms-3">
                                <div class="rates cursor-pointer fs-6">
                                    <i class="bx bxs-star text-warning"></i>
                        ...
                        <div class="d-flex align-items-start">
                            <div class="review-user">
                                <img src="{{asset('assets/admin/images/avatars/avatar-6.png')}}" width="65" height="65" class="rounded-circle" alt="">
                            </div>
                            <div class="review-content ms-3">
                                <div class="rates cursor-pointer fs-6">
                                    <i class="bx bxs-star text-warning"></i>
                        ...
                        <div class="d-flex align-items-start">
                            <div class="review-user">
                                <img src="{{asset('assets/admin/images/avatars/avatar-7.png')}}" width="65" height="65" class="rounded-circle" alt="">
                            </div>
                            <div class="review-content ms-3">
                                <div class="rates cursor-pointer fs-6">
                                    <i class="bx bxs-star text-warning"></i>
                ...
                <div class="card-body p-0">
                    <div class="chat-talk d-flex flex-column gap-4 p-3">
                        <div class="d-flex align-items-end gap-3">
                            <div class="chat-user">
                                <img src="{{asset('assets/admin/images/avatars/avatar-7.png')}}" width="55" height="55" class="rounded-circle" alt="">
                            </div>
